    ...
    <div class="container">
        <div class="app">
            ...
            <ul class="menubar">
                ...
                <li><a href="doenca1.php"><i class="fas fa-arrow-left"></i></a></li>
                <li><a href="doenca3.php"><i class="fas fa-arrow-right"></i></a></li>
            ...
            <div class="news">
                <div class="list">
					...
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterM.png">
                        <h2 class="text-strong">M </h2>
						<p>Lista de Doenças M</p>
                    </div>
                    <BR>
                    <div class="table item" style="border: 1px solid" onclick="location.href='doencaB.php'">
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterN.png">
                        <h2 class="text-strong">N</h2>
						<p>Lista de Doenças N</p>
                    </div>

                    <div class="table item" style="border: 1px solid" onclick="location.href='doencaC.php'">
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterO.png">
                        <h2 class="text-strong">O</h2>
						<p>Lista de Doenças O</p>
                    </div>
                    <div class="table item" style="border: 1px solid">
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterP.png">
                        <h2 class="text-strong">P</h2>
						<p>Lista de Doenças P</p>
                    </div>
                    <div class="table item" style="border: 1px solid">
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterQ.png">
                        <h2 class="text-strong">Q</h2>
						<p>Lista de Doenças Q</p>
                    </div>
                    <div class="table item" style="border: 1px solid">
					<img class="left square avatar" width="50px" height="50px" src="../img/letter/letterR.png">
                        <h2 class="text-strong">R</h2>
						<p>Lista de Doenças R</p>
                    </div>
