        ...
        <div class="w3-row">
            ...
            <div class="w3-col m3">
                ...
                <div
                    ...
                    <p><strong>Mensagens do sistema!</strong></p>
                    <p>
                        <!--As pessoas estão olhando para o seu perfil. Descubra quem.-->
                        <?php 
                        $_SESSION['msg'] = "As pessoas estão olhando para o seu perfil";
                        echo $_SESSION['msg'];
                        unset($_SESSION['msg']);
                    ?>
                    </p>
            ...
            <div class="w3-col m7">
                ...
                <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                    ...
                    <span class="w3-right w3-opacity">ID 
